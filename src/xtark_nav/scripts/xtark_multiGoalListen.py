...
class MultiGoalListen:
    ...
    def robot_pose_callback(self, msg):
        ...
        self.r.hset('CurrentRobotPose', 'x', x)
        self.r.hset('CurrentRobotPose', 'y', y)
        self.r.hset('CurrentRobotPose', 'z', z)
        self.r.hset('CurrentRobotPose', 'qx', qx)
        self.r.hset('CurrentRobotPose', 'qy', qy)
        self.r.hset('CurrentRobotPose', 'qz', qz)
        self.r.hset('CurrentRobotPose', 'qw', qw)
